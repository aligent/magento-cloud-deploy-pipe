...
push_to_secondary_remote() {
     ...
     git push secondary-remote ${BITBUCKET_BRANCH}  2>&1 | tee /dev/stout | grep -i "Opening environment|Everything up-to-date|Deployment completed?|Warmed up page" > /dev/null
}
